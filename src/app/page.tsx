...
export default function Home() {
  ...
  const websiteSchema = {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target: "https://lisani0429.github.io/money-saving-website/articles?q={search_term_string}",
  ...
  const organizationSchema = {
    ...
    name: "无痛省钱攒钱",
    url: "https://lisani0429.github.io/money-saving-website/",
    logo: "https://lisani0429.github.io/money-saving-website/logo.png",
    description: "提供个性化省钱计划、实用省钱技巧和情绪价值",
    sameAs: [
      "https://weibo.com/moneysaving",
      "https://mp.weixin.qq.com/moneysaving",
    ],
  };
