    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="bg-[#FAFAF8] border-b border-[#E8E8E4]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav className="flex items-center gap-2 text-sm text-[#94A3B8]">
              ...
              <Link href="/books" className="hover:text-[#0F4C3A] transition-colors">图书笔记</Link>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <polyline points="9 18 15 12 9 6" />
              </svg>
              <span className="text-[#4A5568] truncate max-w-[200px]">{book.title}</span>
            </nav>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 mb-8 border border-[#E8E8E4]">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex-grow">
                ...
                <p className="text-[#4A5568] text-lg mb-4">{book.author}</p>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-[#94A3B8] ml-1">豆瓣评分</span>
                </div>
          ...
          {/* Related Books */}
          <div>
            <h2 className="text-xl font-bold text-[#0F4C3A] mb-6">相关推荐</h2>
              ...
              {books
                ...
                .map((b) => (
                  ...
                  >
                    ...
                    <h3 className="font-medium text-sm text-[#0F4C3A] line-clamp-1 group-hover:text-[#10B981] transition-colors">{b.title}</h3>
                    <p className="text-[#94A3B8] text-xs">{b.author}</p>
                  </Link>
                ))}
            </div>
          </div>
